...
public class CourtDetailServiceImpl implements CourtDetailService {
	...
	/*
	 * @Override public int insertCourtDetail(CrtDetailInfoVO crtDetailInfoVO) { int
	 * result = courtDetailMapper.insertCourtDetail(crtDetailInfoVO);
	 * 
	 * if(result == 1) { return crtDetailInfoVO.getCrtDetailNo(); } else { return
	 * -1; } }
	 */
